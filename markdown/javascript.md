...
printHello(); // => hello
```
####  20.3. <a name='Withasingleargument'></a>With a single argument 
```javascript
...
###  67. <a name='Gettersandsetters'></a>Getters and setters
...
###  85. <a name='Chainingmultiple.then'></a>Chaining multiple .then()
